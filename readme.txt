# NOTICE
*This WordPress plugin is no longer maintained. It became a nightmare to maintain, as I was receiving too many questions from people who didn't understand it's purpose. Thoes support requests were overwhelming and made providing support to those who actually had reasonble questions, impossible (there were very few reasonable questions about this code though unfortunately).*
...
With the End to end plugin, not even your WordPress installation will be able to decrypt your content due to it's use of true end to end encryption techniques. Theoretically, if your server is hacked, injected JavaScript could be used to capture your encryption key when you re-enter it. I don't have a solution to this right now, but it could theoretically be mitigated through the creation of a browser plugin companion for the plugin.
...
= 1.1.2 =
* Fixed JS bug in backend. Thanks to <a href="https://bensmann.no/">Thomas Bensmann</a> for reporting the bug.

= 1.1.1 =
* Fixed JS bug in backend

= 1.1 =
* Fixed nonce bug. Props to @kasparsd
* Fixed encryption key being sent back to server bug
* Fixed noscript bug
* Fixed frontend form submission to server bug
